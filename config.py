...
# Choose your voice provider: "elevenlabs", "openai", "sarvam", "deepgram", or "cartesia"
DEFAULT_TTS_PROVIDER = "elevenlabs" 
DEFAULT_TTS_VOICE = "Rachel"  # Eleven Labs: Rachel, Chris, Nova, Bella, etc.
...
# OpenAI TTS
OPENAI_TTS_VOICE = "alloy"  # OpenAI: alloy, echo, shimmer
